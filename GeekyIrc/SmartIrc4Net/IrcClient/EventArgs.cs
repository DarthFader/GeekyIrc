...
namespace Meebey.SmartIrc4net
{
    ...
    public class CtcpEventArgs : IrcEventArgs
    {
        ...
        public string CtcpCommand { get { return _CtcpCommand; } }

        public string CtcpParameter { get { return _CtcpParameter; } }
    }
    ...
    public class MotdEventArgs : IrcEventArgs
    {
        ...
        public string MotdMessage { get { return _MotdMessage; } }
    }
    ...
    public class PingEventArgs : IrcEventArgs
    {
        ...
        public string PingData { get { return _PingData; } }
    }
    ...
    public class KickEventArgs : IrcEventArgs
    {
        ...
        public string Whom { get { return _Whom; } }
    ...
    public class ListEventArgs : IrcEventArgs
    {
        ...
        public ChannelInfo ListInfo { get { return f_ListInfo; } }
    }
    ...
    public class PartEventArgs : IrcEventArgs
    {
        ...
        public string PartMessage { get { return _PartMessage; } }
    }
    ...
    public class WhoEventArgs : IrcEventArgs
    {
        ...
        public string Channel { get { return f_WhoInfo.Channel; } }

        [Obsolete("Use WhoEventArgs.WhoInfo instead.")]
        public string Nick { get { return f_WhoInfo.Nick; } }

        [Obsolete("Use WhoEventArgs.WhoInfo instead.")]
        public string Ident { get { return f_WhoInfo.Ident; } }

        [Obsolete("Use WhoEventArgs.WhoInfo instead.")]
        public string Host { get { return f_WhoInfo.Host; } }

        [Obsolete("Use WhoEventArgs.WhoInfo instead.")]
        public string Realname { get { return f_WhoInfo.Realname; } }

        [Obsolete("Use WhoEventArgs.WhoInfo instead.")]
        public bool IsAway { get { return f_WhoInfo.IsAway; } }

        [Obsolete("Use WhoEventArgs.WhoInfo instead.")]
        public bool IsOp { get { return f_WhoInfo.IsOp; } }

        [Obsolete("Use WhoEventArgs.WhoInfo instead.")]
        public bool IsVoice { get { return f_WhoInfo.IsVoice; } }

        [Obsolete("Use WhoEventArgs.WhoInfo instead.")]
        public bool IsIrcOp { get { return f_WhoInfo.IsIrcOp; } }

        [Obsolete("Use WhoEventArgs.WhoInfo instead.")]
        public string Server { get { return f_WhoInfo.Server; } }

        [Obsolete("Use WhoEventArgs.WhoInfo instead.")]
        public int HopCount { get { return f_WhoInfo.HopCount; } }

        public WhoInfo WhoInfo { get { return f_WhoInfo; } }
    }
    ...
    public class AwayEventArgs : IrcEventArgs
    {
        ...
        public string AwayMessage { get { return _AwayMessage; } }
    }
    ...
    public class NickChangeEventArgs : IrcEventArgs
    {
        ...
        public string OldNickname { get { return _OldNickname; } }

        public string NewNickname { get { return _NewNickname; } }
    }
    ...
    public class TopicChangeEventArgs : IrcEventArgs
    {
        ...
        public string NewTopic { get { return _NewTopic; } }
    }
    ...
    public class BanEventArgs : IrcEventArgs
    {
        ...
        public string Hostmask { get { return _Hostmask; } }
    }
